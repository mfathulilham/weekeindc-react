...
function Quotes() {
  return (
    <div className='quotes'>
        <img data-aos="fade-down-left" src={images.path_pink2} alt='path_pink' className='path-pink' />
        <img data-aos="fade-down-left" src={images.astronout} alt='astronout' className='img-astronout' />
        <img src={images.circle_blue} alt='circle_blue' className='circle-blue' />
        <div data-aos="fade-right" className='quotes-content'>
            <p>
